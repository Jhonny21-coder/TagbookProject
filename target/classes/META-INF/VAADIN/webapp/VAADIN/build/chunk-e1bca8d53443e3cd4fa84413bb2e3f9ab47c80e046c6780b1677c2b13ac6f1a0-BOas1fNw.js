import{h,ae as u,a3 as c,k as m,L as g,n as f,p as x,T as v,E as y,P as _}from"./chunk-422c3a2ad42cb7c26cccff5ea772b37973c9526da5f9baabc6ba2b82c6284122-BWrh5vjC.js";import{a as l,r as s,d as b,T as w}from"./indexhtml-DPuqjys-.js";/**
 * @license
 ...
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */s("vaadin-text-area",[f,F],{moduleId:"vaadin-text-area-styles"});class k extends E(w(y(_))){static get is(){return"vaadin-text-area"}static get template(){return x`
    ...
    `}ready(){super.ready(),this._tooltipController=new v(this),this._tooltipController.setPosition("top"),this._tooltipController.setAriaTarget(this.inputElement),this.addController(this._tooltipController)}}b(k);
